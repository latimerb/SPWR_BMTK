...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "na_ion");
 	...
 	ivoc_help("help ?1 na /home/latimerb/SPWR_BMTK/biophys_components/mechanisms/x86_64/na.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/latimerb/SPWR_BMTK/biophys_components/mechanisms/modfiles/na.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
  "\n"
